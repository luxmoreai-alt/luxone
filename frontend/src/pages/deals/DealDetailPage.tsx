        ...
        sectionActions={{
          "products-section": (
            <button
              ...
              className="rounded-md bg-[#365eea] px-3 py-1.5 text-sm font-medium text-white"
            >
              Add Product
            </button>
          ),
        ...
        footer={
          <>
            ...
            <button
              ...
              className="rounded-md bg-[#365eea] px-4 py-2 text-sm font-medium text-white disabled:opacity-60"
            >
