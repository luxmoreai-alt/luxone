    ...
    >
      <div className="space-y-4">
        <input
          ...
          placeholder="Search..."
          className="h-[40px] w-full rounded-md border border-slate-300 px-3 text-sm outline-none focus:border-blue-500"
        />
            ...
            <div className="divide-y divide-slate-100">
              {options.map((option) => (
                ...
                >
                  ...
                  <span className="text-xs font-medium text-blue-600">Choose</span>
                </button>
              ))}
            </div>
          )}
