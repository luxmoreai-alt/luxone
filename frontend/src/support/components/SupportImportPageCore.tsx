  ...
  return (
    <DashboardLayout>
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-6">
          <div className="mb-6 flex flex-wrap gap-2">
            {supportImportSteps.map((item, index) => (
              <div key={item} className={`rounded-full px-3 py-1 text-sm ${step === index + 1 ? "bg-blue-600 text-white" : "bg-slate-100 text-slate-600"}`}>
                {index + 1}. {item}
              </div>
            ))}
          </div>
          ...
          {step === 3 ? (
            <div className="space-y-4">
              <div className="flex gap-2 text-sm">
                <button type="button" className="rounded-md bg-blue-600 px-3 py-2 text-white">Fields Mapping</button>
          ...
          <div className="mt-8 flex items-center justify-between">
            ...
            <button type="button" disabled={saving} onClick={() => void nextStep()} className="rounded-md bg-blue-600 px-4 py-2 text-sm font-medium text-white">
      ...
      <CRMModalBase
        ...
        footer={<button type="button" onClick={() => navigate(meta.baseRoute)} className="rounded-md bg-blue-600 px-4 py-2 text-sm font-medium text-white">OK</button>}
      >
