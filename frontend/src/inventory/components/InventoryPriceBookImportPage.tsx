            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                {[
                  ...
                  <button key={item.key} type="button" onClick={() => setState((prev) => ({ ...prev, source: item.key as PriceBookImportState["source"] }))} className={`rounded-xl border p-5 text-left ${state.source === item.key ? "border-blue-500 bg-blue-50" : "border-slate-200"}`}>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 p-4">
          <div className="w-full max-w-md rounded-xl bg-white p-6 shadow-2xl">
            ...
            <div className="mt-6 flex justify-end">
              <button type="button" onClick={() => navigate("/price-books")} className="rounded-md bg-blue-600 px-4 py-2 text-sm font-medium text-white">
                OK
              </button>
            </div>
          </div>
