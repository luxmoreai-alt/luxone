...
export default function ComposeSettingsForm({ value, providers, submitting = false, onSubmit }: Props) {
  ...
  return (
    <CRMSectionCard
      ...
      action={
        <button type="button" disabled={submitting} onClick={() => onSubmit(form)} className="rounded-md bg-blue-600 px-3 py-2 text-xs font-medium text-white disabled:opacity-60">
