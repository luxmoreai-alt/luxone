...
export default function SocialAdminSettingsPanel({ setting, onSave }: Props) {
  ...
  return (
    <CRMSectionCard title="Social Admin Settings" action={<button type="button" onClick={() => onSave(current)} className="rounded-md bg-blue-600 px-3 py-2 text-xs font-medium text-white">Save Settings</button>}>
