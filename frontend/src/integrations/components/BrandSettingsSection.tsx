...
export default function BrandSettingsSection({ brands, onCreateBrand, onEditBrand, onConnectAccount, onDisconnectAccount }: Props) {
  return (
    <div className="space-y-4">
      <CRMSectionCard title="Brand Settings" action={<button type="button" onClick={onCreateBrand} className="rounded-md bg-blue-600 px-3 py-2 text-xs font-medium text-white">Create Brand</button>}>
        {!brands.length ? (
