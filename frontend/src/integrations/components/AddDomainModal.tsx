    ...
    <CRMModalBase
      ...
      footer={
        <>
          ...
          <button type="button" disabled={submitting} onClick={() => onSubmit(domain)} className="rounded-md bg-blue-600 px-4 py-2 text-sm font-medium text-white disabled:opacity-60">Add Domain</button>
        </>
      }
    >
