...
export default function SocialAutomationRulesPanel({ rules, onCreate, onEdit, onDelete }: Props) {
  return (
    <CRMSectionCard title="Automated Lead Generation" action={<button type="button" onClick={onCreate} className="rounded-md bg-blue-600 px-3 py-2 text-xs font-medium text-white">Add Rule</button>}>
